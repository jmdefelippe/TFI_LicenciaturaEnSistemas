...
public class DueloHomicidio extends javax.swing.JFrame {

    public DueloHomicidio () {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxProcedimientos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione el procedimiento", "Ensañamiento", "Alevosía", "Medio empleado no debería causar la muerte", "Otro procedimiento insidioso" }));
        ...
        getContentPane().add(jLabelDegrade2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 390, 50));
    ...
    private void jComboBoxProcedimientosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxProcedimientosActionPerformed
        if (((String)jComboBoxProcedimientos.getSelectedItem() != "Medio empleado no debería causar la muerte")
