...
public class DueloLesion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxProcedimientos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione el procedimiento", "Ensañamiento", "Alevosía", "Medio empleado no deberia causar la muerte", "Otro procedimiento insidioso" }));
        ...
        jComboBoxMotivos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione el motivo", "Precio", "Promesa remuneratoria", "Placer", "Codicia", "Odio racial", "Odio religioso", "Odio de genero", "Odio a la orientacion sexual", "Odio a la identidad de genero o su expresion", "Medio idoneo para crear un peligro comun", "Funcion/cargo/condicion de seguridad publica/policial/penitenciaria (de la victima)", "Abuso de funcion/cargo de seguridad publica/policial/penitenciaria (del victimario)", "Violencia de genero (De hombre a mujer)", "Causar sufrimiento", "Preparar otro delito", "Facilitar otro delito", "Consumar otro delito", "Ocultar otro delito", "Asegurar resultados de otro delito", "Procurar impunidad para si u otro delito", "No haber logrado el fin de otro delito", "Causar daño en el cuerpo", "Ninguno de los anteriores" }));
