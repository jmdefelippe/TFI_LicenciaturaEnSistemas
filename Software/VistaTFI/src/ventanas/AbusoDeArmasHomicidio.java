...
public class AbusoDeArmasHomicidio extends javax.swing.JFrame {
    
    public AbusoDeArmasHomicidio () {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxProcedimientos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione el procedimiento", "Ensañamiento", "Alevosía", "Emoción violenta", "Medio empleado no debería causar la muerte", "Imprudencia, negligencia o impericia en arte o profesión", "Inobservancia de reglamentos o deberes a cargo", "Otro procedimiento insidioso" }));
        ...
        getContentPane().add(jLabelDegrade2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 460, 50));
        ...
        getContentPane().add(jRadioButtonSi, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 390, 60, -1));
        ...
        getContentPane().add(jRadioButtonNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 420, 60, -1));
