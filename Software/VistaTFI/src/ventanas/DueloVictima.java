...
public class DueloVictima extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonGroup2.add(jRadioButtonConVidaSinLesiones);
        ...
        buttonGroup2.add(jRadioButtonConVidaConLesiones);
        ...
        buttonGroup2.add(jRadioButtonFallecido);
    ...
    private void jButtonSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSiguienteActionPerformed
        ...
        if (jRadioButtonConVidaConLesiones.isSelected()) {
            DueloLesion a = new DueloLesion();
            a.setVisible(true);
            this.setVisible(false);            
        }
        if (jRadioButtonFallecido.isSelected()) {
            DueloHomicidio a = new DueloHomicidio();
            a.setVisible(true);
            this.setVisible(false);            
        }
    ...
    public static String getTipoDelitoDuelo() {
        String resultado = "";
        if (jRadioButtonConVidaSinLesiones.isSelected()) {
            resultado = "Duelo";
        }
        if (jRadioButtonConVidaConLesiones.isSelected()) {
            resultado = "Lesion en duelo";
        }
        if (jRadioButtonFallecido.isSelected()) {
            resultado = "Homicidio en duelo";
        }
        return resultado;
    }        
