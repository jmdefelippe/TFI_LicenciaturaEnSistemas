...
public class SustraccionORetencionDeUnaPersona extends javax.swing.JFrame {
    
    public SustraccionORetencionDeUnaPersona () {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxProcedimientos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione el procedimiento", "Fuerza", "Intimidación", "Fraude" }));
        ...
        getContentPane().add(jLabelDegrade2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 260, 50));
        ...
        getContentPane().add(jTextFieldEdadVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 500, 90, 30));
        ...
        getContentPane().add(jLabelDegrade6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 450, 540, 110));
        ...
        getContentPane().add(jButtonConfirmarDatosVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 480, 170, 50));

        jLabelCircExt.setFont(new java.awt.Font("Calibri", 1, 20)); // NOI18N
        jLabelCircExt.setText("¿Hubo consentimiento por parte de la victima?");
        getContentPane().add(jLabelCircExt, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 590, -1, 20));
        ...
        getContentPane().add(jLabelDegrade7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 580, 840, 40));
        ...
        getContentPane().add(jRadioButtonSi, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 640, 60, -1));
        ...
        getContentPane().add(jRadioButtonNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 670, 60, -1));
        ...
        getContentPane().add(jLabelDegrade8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 640, 150, 60));
    ...
    private void jComboBoxProcedimientosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxProcedimientosActionPerformed
        if ((String)jComboBoxProcedimientos.getSelectedItem() != "Seleccione el procedimiento") {
            ...
            if ((!jTextFieldNombreApellidoVictimario.isEnabled()) && (!jTextFieldNombreApellidoVictima.isEnabled())
