...
public class DifusionDeImagenesYEspectaculosPornograficosDeMenores extends javax.swing.JFrame {

    public DifusionDeImagenesYEspectaculosPornograficosDeMenores () {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxProcedimientos.setFont(new java.awt.Font("Calibri", 0, 16)); // NOI18N
        jComboBoxProcedimientos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione el procedimiento", "Difusión de representaciones con contenido sexual de menores", "Organización de espectaculos en vivo de representaciones sexuales explícitas donde participen menores de edad", "Posesión de representaciones con contenido sexual de menores", "Posesión de representaciones con contenido sexual de menores (con fines inequívocos de distribución o comercialización)", "Facilitación de acceso a espectáculos pornográficos o suministro de material pornográfico a menores de 14 años" }));
        ...
        getContentPane().add(jComboBoxProcedimientos, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, -1));
        ...
        getContentPane().add(jLabelDegrade2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 840, 50));
        ...
        getContentPane().add(jButtonConfirmarDatosVictimario, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 290, 170, 50));
        ...
        getContentPane().add(jLabelDatosVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 400, -1, 20));
        ...
        getContentPane().add(jLabelNombreApellidoVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 470, -1, -1));
        ...
        getContentPane().add(jTextFieldNombreApellidoVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 500, 270, 30));
        ...
        getContentPane().add(jLabelDNIVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 470, -1, -1));
        ...
        getContentPane().add(jTextFieldDNIVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 500, 100, 30));
        ...
        jLabelEdadVictima.setText("Edad (Menor de 18):");
        getContentPane().add(jLabelEdadVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 470, -1, -1));

        jTextFieldEdadVictima.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jTextFieldEdadVictima.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldEdadVictimaActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(jTextFieldEdadVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 500, 150, 30));
        ...
        getContentPane().add(jLabelDegrade6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 450, 600, 110));
        ...
        getContentPane().add(jButtonConfirmarDatosVictima, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 480, 170, 50));
    ...
    private void jComboBoxProcedimientosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxProcedimientosActionPerformed
        if ((String)jComboBoxProcedimientos.getSelectedItem() != "Seleccione el procedimiento") {
            if (jTextFieldNombreApellidoVictimario.isEnabled()) {
    ...
    private void jButtonConfirmarDatosVictimarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmarDatosVictimarioActionPerformed
        if ((!jTextFieldNombreApellidoVictimario.getText().isEmpty()) && (!jTextFieldDNIVictimario.getText().isEmpty()) && (!jTextFieldEdadVictimario.getText().isEmpty())) {
            ...
            jButtonConfirmarDatosVictimario.setVisible(false);
    ...
    private void jTextFieldEdadVictimaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldEdadVictimaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldEdadVictimaActionPerformed
    ...
    private void jTextFieldEdadVictimaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldEdadVictimaKeyTyped
     ...
     public static String getProcedimiento() {
        ...
        switch (resultado) {    
            case "Difusión de representaciones con contenido sexual de menores":
                resultado = "Difusion de representaciones con contenido sexual de menores";
                break;     
            case "Organización de espectaculos en vivo de representaciones sexuales explícitas donde participen menores de edad":
                resultado = "Organizacion de espectaculos en vivo de representaciones sexuales explicitas donde participen menores de edad";
                break;
            case "Posesión de representaciones con contenido sexual de menores":
                resultado = "Posesion de representaciones con contenido sexual de menores";
                break;
            case "Posesión de representaciones con contenido sexual de menores (con fines inequívocos de distribución o comercialización)":
                resultado = "Posesion de representaciones con contenido sexual de menores (con fines inequivocos de distribucion o comercializacion)";
                break;
            case "Facilitación de acceso a espectáculos pornográficos o suministro de material pornográfico a menores de 14 años":
                resultado = "Facilitacion de acceso a espectaculos pornograficos o suministro de material pornografico a menores de 14 anios";
                break;                
        }
        return resultado;
    }       
