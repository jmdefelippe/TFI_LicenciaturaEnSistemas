...
public class AbortoMedico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelDatosVictimario.setText("Ingrese los datos del médico:");
        ...
        jLabelRelacionConVictima.setText("Seleccione la relación del victimario con la mujer a la que se le realizó el aborto:");
        ...
        jLabelRol.setText("Seleccione el rol del médico en el caso:");
        ...
        getContentPane().add(jLabelCantidadVictimarios2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 555, -1, -1));
        ...
        jLabelCantidadVictimarios3.setText("(Más de 2)");
        getContentPane().add(jLabelCantidadVictimarios3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 575, -1, -1));
        ...
        getContentPane().add(jTextFieldCantidadVictimarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 560, 70, 30));
...
//        if ((c<'a' || c>'z' ) && (c<'A' || c>'Z') && (c==' ')) evt.consume();
    ...
    private void jButtonConfirmarDatos1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmarDatos1ActionPerformed
        if ((!jTextFieldNombreApellido.getText().isEmpty()) && (!jTextFieldDNI.getText().isEmpty()) && (!jTextFieldEdad.getText().isEmpty())) {
            jLabelDegrade3.setVisible(true);
            jLabelRelacionConVictima.setVisible(true);
            jLabelDegrade4.setVisible(true);
            jRadioButtonAscendenteDescendente.setVisible(true);
            jRadioButtonConyugeExConyuge.setVisible(true);
            jRadioButtonParejaExPareja.setVisible(true);
            jRadioButtonOtra.setVisible(true);
